...
# -------------------- SKLEP, KOSZYK, DOSTAWA, TOP-UP (bez zmian) --------------------
# (wszystkie funkcje shop, add, cart, checkout, topup – tak jak poprzednio)
